...
- Camel AS2 ([guide](https://camel.apache.org/camel-quarkus/latest/reference/extensions/as2.html)): Transfer data securely and reliably using the AS2 protocol (RFC4130)
